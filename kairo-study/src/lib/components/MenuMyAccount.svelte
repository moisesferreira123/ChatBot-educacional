...
<div class="custom-shadow fixed top-[60px] right-[90px] p-[4px] bg-white border border-[var(--color13)]">
  ...
  <div class="flex flex-col">
    ...
    <button class="flex mt-[4px] pt-[6px] pb-[6px] pl-[8px] pr-[8px] w-full font-medium cursor-pointer rounded transition-all duration-200 hover:bg-[var(--color8)]">
